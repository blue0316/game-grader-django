...
from core.views import SignupView, LoginView, InviteTeamView, DashboardView, ProfileView, ManageTeamView, AddgameView, HomeView, NewPlanView, NewEventView, log_out
